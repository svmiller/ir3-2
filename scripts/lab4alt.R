...
#' I'll ask you to figure stuff out like this yourself. It's good experience.
#' 
...
#' from another program. Stata will guess stuff on your behalf. R won't. In this
#' case, Stata can infer you meant `log_jointsize` in the data when you asked for
#' `logsize`. R 100% won't do that for you. Beyond that, reducing the raw data
#' to a simple form for the sake of the analysis isn't that hard.
...
#' I didn't give you things to consider.
#' 
