...
\tightlist
\item
  Inttroduce the basic intuition behind linear regression.
\item
...
to H.P. Gray (1966) and is still pertinent.
...
\tightlist
\item
  \emph{ed.~notice how I'm upselling you on the value of doing this in
  the first place\ldots{}}
\end{itemize}
\end{frame}

\begin{frame}{A Simple Exercise}
...
\begin{table}
\centering\centering
\caption{\label{tab:unnamed-chunk-3}Cross-National Correlates of International Tourism Arrivals}
\centering
...
\begin{table}
\centering\centering
\caption{\label{tab:unnamed-chunk-4}Cross-National Correlates of International Tourism Arrivals}
\centering
\fontsize{6}{8}\selectfont
