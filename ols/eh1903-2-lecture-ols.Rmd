...
(Vi har $y = mx + b$ på USA...)

### Demystifying Regression

That was the slope-intercept equation.

- $m$ (eller $b$ på USA) is the intercept: the observed $y$ when $x$ = 0.
- $k$ (eller $m$ på USA) is the familiar "rise over run", measuring the amount of change in $y$ for a unit change in $x$.
...
Data %>%
  ...
  theme_steve() +
    labs(title = "Faceted Scatterplots of Bivariate Relationships",
       ...
       subtitle = "All relationships are positive. The, the relative price correlation is a bit surprising (prima facie). In all cases, the line drawn is the OLS line for a simple bivariate model.",
       caption = "Data: World Bank Data repository, through various other places.")
...
modelsummary(list("Bivariate" = M0, 
             ...
             output = "kableExtra",
             stars = TRUE,
             title = "Cross-National Correlates of (Logged) International Tourism Arrivals",
